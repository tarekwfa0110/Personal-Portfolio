...
function Main() {
    return (
        <div className="flex flex-col-reverse md:flex-row justify-between items-center text-white w-full gap-4 md:gap-8">
            <div className="flex flex-col gap-4 md:gap-7 text-center md:text-left w-full">
                ...
                <div className="flex gap-4 md:gap-8 items-center justify-center md:justify-start mt-2">
